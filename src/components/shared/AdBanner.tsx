...
export default function AdBanner() {
  return (
    <div className="w-full my-8 flex justify-center items-center">
      <Link href="https://www.instagram.com/theorenz_merch/?hl=en" target="_blank" rel="noopener noreferrer" className="w-full max-w-4xl h-[90px] md:h-[120px] bg-slate-900 border border-slate-800 flex overflow-hidden group hover:border-orange-500 transition-colors relative">
        {/* Background Graphic */}
