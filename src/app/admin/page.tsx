    ...
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        <div className="bg-slate-900 border border-slate-800 p-6 rounded-xl flex items-center gap-4">
          <div className="w-12 h-12 bg-slate-800 rounded-lg flex items-center justify-center text-orange-500">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        <div className="bg-slate-900 border border-slate-800 rounded-xl overflow-hidden">
          <div className="p-6 border-b border-slate-800 flex justify-between items-center">
            ...
            <button className="text-xs font-bold text-orange-500 hover:text-white transition-colors">Tulis Baru +</button>
          </div>
        ...
        <div className="bg-slate-900 border border-slate-800 rounded-xl overflow-hidden">
          <div className="p-6 border-b border-slate-800 flex justify-between items-center">
            ...
            <button className="text-xs font-bold text-yellow-400 hover:text-white transition-colors">Tambah Pertandingan +</button>
          </div>
          <div className="p-12 text-center text-slate-500 text-sm font-medium">
