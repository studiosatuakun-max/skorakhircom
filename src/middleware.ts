...
const publicRoutes = ['/affiliate', '/anggota', '/berita', '/kategori', '/admin', '/api', '/_next', '/world-cup-2026', '/feed', '/tentang-kami', '/redaksi', '/pedoman-media-siber', '/kontak', '/tag', '/polling', '/author'];
